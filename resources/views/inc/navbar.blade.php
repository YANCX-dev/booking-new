<nav class="navbar navbar-expand-lg navbar-light bg-info p-3 shadow">
    <div class="container-fluid">
        <a class="navbar-brand" href="#">H&B</a>
        ...
        <div class=" collapse navbar-collapse" id="navbarNavDropdown">
            <ul class="navbar-nav ms-auto ">
                <li class="nav-item">
                    <a class="nav-link mx-2 active text-white" aria-current="page" href="#">Главная</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link mx-2 text-white" href="#">Отели</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link mx-2 text-white" href="#">Акции</a>
                </li>
